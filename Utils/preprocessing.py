...
def remove_article_connector(text):
    article = ["BUT","YET","YOU","THE","WAS","FOR","ARE","THEY","THIS","THAT","WERE","WITH","YOUR","JUST","WILL","WHO","ABOUT","THEIR","OUR","HAS","WHO","GET","THEM","WHAT","CAN","IS","HIS","MORE","OUT","FROM","HAVE","HERE","WE","ALL","THERE","TO","ALSO","AND","AS","NOT"]
    pre_words=[]
    for word in text:
